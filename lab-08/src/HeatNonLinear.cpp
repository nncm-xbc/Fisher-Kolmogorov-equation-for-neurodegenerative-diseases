          ...
          for (unsigned int i = 0; i < dofs_per_cell; ++i)
            {
              for (unsigned int j = 0; j < dofs_per_cell; ++j)
                {
                  ...
                  cell_matrix(i, j)+=alpha_loc*fe_values.shape_value(j,q)*fe_values.shape_value(i,q)*fe_values.JxW(q);

                  cell_matrix(i,j)-=2.0*alpha_loc*solution_loc[q]*fe_values.shape_value(j,q)*fe_values.shape_value(i,q)*fe_values.JxW(q);

                  cell_matrix(i,j) += scalar_product(D_loc * fe_values.shape_grad(j, q), 
              ...
              cell_residual(i)-= scalar_product(D_loc * solution_gradient_loc[q], 
                                       fe_values.shape_grad(i, q) )*
                                       fe_values.JxW(q);  

              cell_residual(i)-=alpha_loc*solution_loc[q]*(1.0-solution_loc[q])*fe_values.shape_value(i,q)*fe_values.JxW(q);
